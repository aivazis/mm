...
test_completion "Complete 'extern.verify'" "mm extern.verify" "extern\\.verify"
test_completion "Complete 'extern.db'" "mm extern.db" "extern\\.db\\.info"
...
check_description "extern.verify" "active externals"
check_description "extern.db.info" "package database"
check_description "extern.hdf5.verify" "Verify an external package"
...
check_target "extern.verify"
check_target "extern.db.info"
...
check_target "fullproj.wp.lock.seed"
check_target "fullproj.wp.schema"
...
check_target "fullproj.vt.bundle"
check_target "fullproj.vt.lock.seed"
